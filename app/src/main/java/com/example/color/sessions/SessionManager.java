package com.example.color.sessions;
...
public class SessionManager {
    ...
    public void createLoginSession(String fullName, String userName, String email, String password, String address, String gender, String phone, String birthday) {
