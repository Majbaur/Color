...
import static com.example.color.sessions.SessionManager.USER_LOGIN_SESSION;
...
import com.example.color.helperActivity.UserProfile;
import com.example.color.models.UserModel;
import com.example.color.services.AboutActivity;
import com.example.color.services.BlogActivity;
import com.example.color.services.ClassifyActivity;
import com.example.color.services.ColorsActivity;
import com.example.color.services.MapActivity;
import com.example.color.services.QnAActivity;
import com.example.color.sessions.SessionManager;
import com.example.color.starter.SignInActivity;
